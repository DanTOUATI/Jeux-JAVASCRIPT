...
function stop() 
{
	...
	if (nb_coup == 0) 
	{
		...
		document.getElementById('aff').innerHTML += "********** " + "<em>Fin de la partie!!"+" **********" +"<br> Vous finissez la partie avec un total de " + score + " points" + "</em>" ;
...
dans une seule variable, récupère l'attribution de la fonction au dessus
*/
function affInformation(a) 
{
	document.getElementById('aff').innerHTML = "";
	var aff = "<p><b>Score : </b>"+score+"</p>";
	aff += "<p><b>Nombre de coups restants : </b>"+nb_coup+"</p>";
